...
function Packer:init_ensure_plugins()
  ...
  if not state then
    local cmd = '!git clone https://github.com/whthomason/packer.nvim' .. packer_dir
...
function plugins.load_compile()
  if fn.filereadable(packer_compiled) then
    require('packer_compiled')
  else
  ...
  api.nvim_create_autocmd('BufWritePost', {
    ...
    desc = 'Auto Compile the neovim config from lua'
  })
end
