...
function M.statuscolumn()
  ...
  local show_open_folds = vim.g.statuscolumn_folds_open
  local use_githl = vim.g.statuscolumn_folds_githl

  if show_signs then
    local signs = get_signs(buf, vim.v.lnum)

    local left, right, fold, githl ---@type Sign?, Sign?, Sign?, string?
