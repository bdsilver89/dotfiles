return {
  ...
  config = function()
    ...
    local LSPActive = {
      ...
      provider = Utils.get_icon("ActiveLSP") .. " LSP",
      -- provider  = function(self)
      --     local names = {}
    ...
    local Diagnostics = {
      ...
      {
        provider = function(self)
          return self.errors > 0 and (Utils.get_icon("DiagnosticError") .. self.errors .. " ")
        end,
        hl = "DiagnosticError",
      },
      {
        provider = function(self)
          return self.warnings > 0 and (Utils.get_icon("DiagnosticWarn") .. self.warnings .. " ")
        end,
        hl = "DiagnosticWarn",
      },
      {
        provider = function(self)
          return self.info > 0 and (Utils.get_icon("DiagnosticInfo") .. self.info .. " ")
        end,
        hl = "DiagnosticInfo",
      },
      {
        provider = function(self)
          return self.hints > 0 and (Utils.get_icon("DiagnosticHint") .. self.hints)
        end,
        hl = "DiagnosticHint",
      },
    }
    ...
    local DAPMessages = {
      ...
      provider = function()
        return Utils.get_icon("Debugger") .. require("dap").status() .. " "
      end,
      hl = "Debug",
      {
        provider = " ",
