...
function plugins.load_compile()
	...
	vim.cmd([[command! PackerCompile lua require('core.packer').back_compile()]])
	...
	vim.cmd([[autocmd User PackerComplete lua require('core.packer').back_compile()]])
	vim.cmd([[command! PackerStatus lua require('core.packer').compile() require('packer').status()]])
end
